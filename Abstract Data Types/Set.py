...
'''
 ...
 It can be added or removed elements from that set and can be done
 operations related with other sets like union, intersection, difference
 and subset.
...
class Dynamic_Set:
	...
	def get_list(self): # Returns the set
		return self.__element_list

	def union(self, secondary_set): # Returns the union of the set and another received one
		try:
			aux = []
	...
	def intersection(self, secondary_set): # Returns the intersection of the set and received one
		try:
			aux = []
	...
	def difference(self, secondary_set): # Returns the difference of the set and received one
		try:
			aux = []
	...
	def subset(self, secondary_set): # Returns "True" if the set is a subset of the received one, "False" if not
		try:
	...
	def remove(self, element): # Removes an element of the set
		try:
	...
	def clear(self): # Erases all elements from the set
